...
<p><b><h3> Rencana Produksi </h3></b></p>
...
if(mysqli_num_rows($brg)){
  ...
  <tbody>
    <tr>
      ...
      <td>&nbsp;<a href="data.php?id=<?php echo $row['id']; ?>"><button type="button" class="btn btn-success">Create Request Packaging card</button></a>&nbsp;<a href="editrp.php?id=<?php echo $row['sc']; ?>"><button type="button" class="btn btn-success">Edit</button></a> &nbsp; <a href="hapus.php?id=<?php echo $row['sc']; ?>"><button type="button" class="btn btn-danger">Hapus</button></a> &nbsp; <a href="detailrp.php?id=<?php echo $row['sc']; ?>"><button type="button" class="btn btn-info">Detail</button></a></td>
...
<div class="row">
   ...
   echo " <a href='#'><button type='button' class='btn btn-danger'>Hapus Semua</button></a>";
    echo "</div>";
   }else{
